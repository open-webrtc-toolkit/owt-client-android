...
def run_unit_test(log_dir, device):
    ...
    for module, unit_test in UNIT_TESTS.items():
        ...
        result_file = run_cases(TestMode.UNIT, module, unit_test['target'], log_dir,
                                device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--instrumentation', dest='instrumentation', default=False,
    ...
    result = False
    validate_result = validate_caselist(args.instrumentation)

    if validate_result and not args.unit:
        sys.exit(1)
