...
import static com.intel.webrtc.test.util.Config.CHINESE_CHARACTER;
import static com.intel.webrtc.test.util.Config.CONFERENCE_ROOM_ID;
import static com.intel.webrtc.test.util.Config.CONFERENCE_ROOM_ID_INCORRECT;
import static com.intel.webrtc.test.util.Config.CONFERENCE_SERVER_HTTP;
import static com.intel.webrtc.test.util.Config.CONFERENCE_SERVER_HTTPS;
import static com.intel.webrtc.test.util.Config.CONFERENCE_SERVER_INCORRECT;
import static com.intel.webrtc.test.util.Config.CONFERENCE_TOKEN_FAKE;
import static com.intel.webrtc.test.util.Config.CONFERENCE_TOKEN_INCORRECT;
import static com.intel.webrtc.test.util.Config.ERROR_ROLE;
...
import static com.intel.webrtc.test.util.Config.USER3_NAME;
...
import com.intel.webrtc.test.conference.util.HttpUtils;
