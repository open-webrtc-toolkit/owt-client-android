...
import static oms.test.conference.util.ConferenceAction.mute;
...
import static oms.test.conference.util.ConferenceAction.unmute;
...
import oms.test.conference.util.ConferenceAction;
