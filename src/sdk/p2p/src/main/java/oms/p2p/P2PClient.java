...
import static oms.p2p.P2PClient.ServerConnectionStatus.CONNECTING;
import static oms.p2p.P2PClient.ServerConnectionStatus.DISCONNECTED;
import static oms.p2p.P2PClient.SignalingMessageType.CHAT_CLOSED;
import static oms.p2p.P2PClient.SignalingMessageType.CHAT_DATA_ACK;
import static oms.p2p.P2PClient.SignalingMessageType.CHAT_UA;
import static oms.p2p.P2PClient.SignalingMessageType.NEGOTIATION_REQUEST;
import static oms.p2p.P2PClient.SignalingMessageType.SIGNALING_MESSAGE;
import static oms.p2p.P2PClient.SignalingMessageType.STREAM_INFO;
